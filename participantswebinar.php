...
if(!$_POST){
    header("Location: webinarmanager.php");
}
?>
	...
	<div class="main">
        ...
        <div>
            ...
            <tr>
                ...
                $email=$_SESSION['user'];
                $query = "SELECT U.email,U.name,U.surname FROM USER U JOIN PARTICIPATIONWEBINAR P WHERE U.email=P.email AND P.id='$eventID'";
